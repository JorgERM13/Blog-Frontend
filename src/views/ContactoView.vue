    ...
    <div class="container bg-white pt-5">
        <div class="row px-3 pb-2">
            ...
            <div class="col-sm-4 text-center mb-3">
                ...
                <h4 class="font-weight-bold">Móbil</h4>
                <p>+591 70748844</p>
            </div>
            <div class="col-sm-4 text-center mb-3">
                <i class="far fa-2x fa-envelope mb-3 text-primary"></i>
                <h4 class="font-weight-bold">Email</h4>
                <p>jerm0012@gmail.com</p>
            </div>
        </div>
        <div class="col-md-12 pb-5">
            <div class="contact-form">
                <div v-show="emviado == true" class="alert alert-success">Mensaje enviado correctamente</div>

                <div class="control-group">
                    <input type="text" v-model="nombre" class="form-control" placeholder="Ingrese su nombre completo"
                ...
                <div class="control-group">
                    <textarea v-model="mensaje" class="form-control" rows="8" placeholder="Message" required="required"
                        data-validation-required-message="Escribe tu mensaje"></textarea>
                    <p class="help-block text-danger"></p>
                </div>
                <div>
                    <button @click="enviarMensaje()" class="btn btn-primary" type="submit" id="sendMessageButton">Enviar
                        mensaje</button>
                </div>
...
export default {
    setup() {
        ...
        const baseUrl = 'http://hamilo_blog.test/api';
