            ...
            <slide v-for="slide in slides" :key="slide" class="carousel-inner">
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <h2 class="text-white font-weight-bold">{{ slide.titulo }}</h2>
                        <div class="d-flex">
                        ...
                        <RouterLink :to="'/vermas/' + slide.id" class="btn btn-lg btn-outline-light mt-4">Ver mas
                        </RouterLink>
        ...
        <div v-for="item in posts" :key="item.id" class="row blog-item px-3 pb-5">
            ...
            <div class="col-md-7">
                ...
                <div class="d-flex mb-3">
                    ...
                    <small class="mr-2 text-muted"><i class="fa fa-comments"></i>{{ item.cat_comentarios }}
                        Comentarios</small>
                </div>
                <p>
                    {{ item.resumen }}
                ...
                <RouterLink :to="'/vermas/' + item.id" class="btn btn-lg btn-outline-light mt-4">Leer mas
